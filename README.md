...
[![Build Status](https://travis-ci.org/UnipayFI/go-aster.svg?branch=master)](https://travis-ci.org/UnipayFI/go-aster)
[![GoDoc](https://godoc.org/github.com/UnipayFI/go-aster?status.svg)](https://godoc.org/github.com/UnipayFI/go-aster)
[![Go Report Card](https://goreportcard.com/badge/github.com/UnipayFI/go-aster)](https://goreportcard.com/report/github.com/UnipayFI/go-aster)
[![codecov](https://codecov.io/gh/UnipayFI/go-aster/branch/master/graph/badge.svg)](https://codecov.io/gh/UnipayFI/go-aster)
...
```shell
go get github.com/UnipayFI/go-aster/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/UnipayFI/go-aster/v1
```
...
import (
    ...
    "github.com/UnipayFI/go-aster/v2/futures" // optional package
    "github.com/UnipayFI/go-aster/v2/delivery" // optional package
    "github.com/UnipayFI/go-aster/v2/options" // optional package
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/UnipayFI/go-aster) for full references.
...
```go
import (
    "github.com/UnipayFI/go-aster/v2/futures"
)
...
```go
import (
    "github.com/UnipayFI/go-aster/v2/delivery"
)
